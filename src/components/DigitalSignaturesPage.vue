...
const items = [
  ...
  { id: 'ЦП 3046', date: '11.05', initials: 'ОД', client: 'Орлов Дмитрий',   phone: '+7 903 ***-**-72', fullPhone: '+7 903 811-45-72', center: 'Контур',  signMethod: 'Онлайн', activationDate: '11.05.2026', expiryDate: '11.11.2027', duration: '1,5 года', courierDate: null,           status: 'Заявление создано в УЦ',         manager: 'Орлов Дмитрий'  },
  ...
  { id: 'ЦП 3044', date: '07.05', initials: 'ЛИ', client: 'Лебедев Игорь',   phone: '+7 499 ***-**-55', fullPhone: '+7 499 123-00-55', center: 'Тензор',  signMethod: 'Онлайн', activationDate: '07.05.2026', expiryDate: '07.11.2027', duration: '1,5 года', courierDate: '14 мая 2026',  status: 'Ожидает назначение курьера',     manager: 'Воронова Анна'  },
  ...
  { id: 'ЦП 3042', date: '04.05', initials: 'МС', client: 'Морозов Сергей',   phone: '+7 912 ***-**-88', fullPhone: '+7 912 300-14-88', center: 'SignMe',  signMethod: 'Онлайн', activationDate: '04.05.2026', expiryDate: '04.11.2027', duration: '1,5 года', courierDate: '16 мая 2026',  status: 'Встреча с курьером отменена',    manager: 'Орлов Дмитрий'  },
  { id: 'ЦП 3041', date: '01.05', initials: 'КМ', client: 'Кузнецова Мария',  phone: '+7 926 ***-**-04', fullPhone: '+7 926 711-88-04', center: 'Тензор',  signMethod: 'Офис',   activationDate: '01.05.2026', expiryDate: '01.05.2027', duration: '1 год',    courierDate: '19 мая 2026',  status: 'Встреча с курьером состоялась',  manager: 'Морозов Сергей' },
  { id: 'ЦП 3040', date: '28.04', initials: 'АП', client: 'Алексеев Пётр',    phone: '+7 915 ***-**-31', fullPhone: '+7 915 462-55-31', center: 'Контур',  signMethod: 'Онлайн', activationDate: '28.04.2026', expiryDate: '28.10.2027', duration: '1,5 года', courierDate: null,           status: 'Запрос на выпуск истек',         manager: 'Лебедев Игорь'  },
  ...
  { id: 'ЦП 3038', date: '22.04', initials: 'ТВ', client: 'Тихонов Виктор',   phone: '+7 903 ***-**-45', fullPhone: '+7 903 159-60-45', center: 'Тензор',  signMethod: 'Онлайн', activationDate: '22.04.2026', expiryDate: '22.10.2027', duration: '1,5 года', courierDate: null,           status: 'Активирована',                   manager: 'Смирнова Юлия'  },
]
